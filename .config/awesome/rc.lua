...
mymainmenu = awful.menu({ items = { { "Settings", myawesomemenu },
                                    { "Terminal", terminal }
                                  }
                        })
...
awful.screen.connect_for_each_screen(function(s)
    -- Wallpaper
    set_wallpaper(s)
    s.padding = { top = "10", bottom = "10", left="10", right="10" }

    -- Each screen has its own tag table.
    awful.tag({ "Main", "Social", "Games", "Code", "School" }, s, awful.layout.layouts[1])
...
globalkeys = gears.table.join(
    ...
    -- Menubar
    awful.key({ modkey }, "p", function() awful.spawn.with_shell("~/.config/rofi/launchers/misc/launcher.sh") end,
...
awful.spawn.with_shell("xrandr --output HDMI-0 --left-of HDMI-1")
